...
function parseJavaScriptProjectInternal(files: Record<string, string>, options?: ParserParseOptions): IRProject {
...
export function parseJavaScriptProject(files: Record<string, string>, options?: ParserParseOptions): IRProject {
  return parseJavaScriptProjectInternal(files, options);
}

function parseWithTreeSitter(Parser: any, JavaScript: any, entries: FileEntry[]): IRProject {
